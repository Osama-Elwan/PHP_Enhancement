...
var_dump(trim("-.osama-.","."));
var_dump(trim('      osama   '));
var_dump(rtrim('      osama   '));
var_dump(ltrim('      osama   '));



var_dump(strpos($text,"PHP"));//return index of the text search about 
var_dump(strpos($text,'PHP',1));
var_dump(strpos($text,"lalala"));//return false important
